  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Hi, I am Front End Developer from Indonesia"
        />
      ...
      <Parallax pages={5} style={{ top: "0", left: "0" }}>
        <ParallaxLayer offset={0}>
          ...
          <div className="ve-container min-h-screen">
              ...
              <div className={`${styles.introContent} intro-content`}>
                ...
                <div className="right">
                  ...
                  <section className={styles.introDetailGroup}>
                    ...
                    <p className={styles.introDetailValue}>
                      React Native, Javascript, HTML, CSS, Laravel
                    </p>
                  </section>
                </div>
              </div>
        ...
        <ParallaxLayer offset={4} style={{display:'flex', flexDirection:'column', justifyContent:'flex-end'}}>
          <AboutMe />
